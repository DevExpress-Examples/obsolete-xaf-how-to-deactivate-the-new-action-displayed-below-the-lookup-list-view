...
Partial Public Class HowToRemoveNewButtonWindowsFormsApplication
	...
	Private Sub HowToRemoveNewButtonWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
