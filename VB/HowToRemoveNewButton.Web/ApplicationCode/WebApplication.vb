...
Partial Public Class HowToRemoveNewButtonAspNetApplication
	Inherits WebApplication
	Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
    Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
	Private module3 As HowToRemoveNewButton.Module.HowToRemoveNewButtonModule
	Private module4 As HowToRemoveNewButton.Module.Web.HowToRemoveNewButtonAspNetModule
	...
	Private Sub HowToRemoveNewButtonAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
	...
	Private Sub InitializeComponent()
		...
		Me.module3 = New HowToRemoveNewButton.Module.HowToRemoveNewButtonModule()
		Me.module4 = New HowToRemoveNewButton.Module.Web.HowToRemoveNewButtonAspNetModule()
		...
		' sqlConnection1
		' 
		Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=HowToRemoveNewButton;Integrated Security=SSPI;Pooling=false"
		Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
		' 
		' HowToRemoveNewButtonAspNetApplication
		' 
		Me.ApplicationName = "HowToRemoveNewButton"
		...
		AddHandler Me.DatabaseVersionMismatch, AddressOf HowToRemoveNewButtonAspNetApplication_DatabaseVersionMismatch
